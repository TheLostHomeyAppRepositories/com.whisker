...
/**
 * WhiskerRobot is a wrapper around the robot data and API, providing
...
class WhiskerRobot {
  ...
  get statusDescription() {
    ...
    const description = WhiskerRobot.StatusDescriptions[code];
    if (!description) {
  ...
  get cycleStateDescription() {
    ...
    return WhiskerRobot.CycleStateStateDescriptions[state] || "Unknown Status";
  }
